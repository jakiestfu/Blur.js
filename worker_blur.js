/**
 * Created by Daniel San Luis on 29/04/14.
 */
...
self.addEventListener('message', function(e) {
    var data = e.data;
    if (data.cmd === 'get-blurred-image') {
        var blurred_image = workerStackBoxBlurCanvasRGB(data.canvas, 0, 0, data.canvas_width, data.canvas_height, data.options_radius, data.iterations);
        var postMessageData = {
            'cmd':          'get-blur',
            'canvas':        blurred_image
        };
...
function workerStackBoxBlurCanvasRGB(imageData, top_x, top_y, width, height, radius, iterations) {
